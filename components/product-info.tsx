  ...
  return (
    <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
      ...
      <div className="mt-3">
        ...
        <p className="text-3xl tracking-tight">{ formatCurrencyString({currency : product.currency,
      ...
      <div className="mt-4">
        ...
        {product.sizes.map((size: any) => (
          <Button onClick={()=>setSize(size)} key={size} variant={`${selectedSize === size? "default" : "outline"}`} className="mr-2 mt-4">
            {getSizeName(size)}
          </Button>
        ))}
      </div>
